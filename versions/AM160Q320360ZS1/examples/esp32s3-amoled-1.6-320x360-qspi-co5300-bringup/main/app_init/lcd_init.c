...
static void lvgl_port_update_callback(lv_display_t *disp) {
    ...
    case LV_DISPLAY_ROTATION_0:
        ...
        esp_lcd_touch_set_mirror_x(tp, TOUCH_MIRROR_X);
        esp_lcd_touch_set_mirror_y(tp, TOUCH_MIRROR_Y);
        break;
    case LV_DISPLAY_ROTATION_90://AMOLED无硬件旋转90度
        // Rotate LCD display
    ...
    case LV_DISPLAY_ROTATION_180:
        ...
        break;
    case LV_DISPLAY_ROTATION_270://AMOLED无硬件旋转270度
        // Rotate LCD display
        //esp_lcd_panel_swap_xy(panel_handle, true);
        esp_lcd_panel_mirror(panel_handle, false, false);
        break;
...
esp_err_t app_lcd_init(void) {
    ...
    //ESP_ERROR_CHECK(esp_lcd_new_panel_qspi_amoled(io_handle, &vendor_config, &panel_handle));
...
esp_err_t app_touch_init(void) {
    ...
    tp_io_config.scl_speed_hz = 0; // legacy i2c_lcd driver requires this unset
    ...
    return esp_lcd_touch_new_i2c_cst820(tp_io_handle, &tp_cfg, &tp);
}

esp_err_t app_lvgl_init() {
    esp_log_level_set("qspi_amoled", ESP_LOG_NONE);  // 或 ESP_LOG_WARN
